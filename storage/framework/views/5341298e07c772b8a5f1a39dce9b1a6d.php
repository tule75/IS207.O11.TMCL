...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/css/home-resposive.css')); ?>">
      ...
      <div class="dropdown">
        ...
        <div class="banner">
            <div class="banner-img">
                ...
                <img class="banner-img-link" src="<?php echo e(asset('/img/CARTIER_HAUTEJO_1920x800_HEADER_ALL-WATCHES_V2.webp')); ?>"alt="">
        ...
        <div class="main-content">
                ...
                <div class="sort-item">
                    ...
                    <div class="btn-sort-name">
                        <button class="fromaz az-item" data-sort-type="az">
                            <p>Sort name by </p> 
                            <img class="az" src="<?php echo e(asset('/img/3682482.png')); ?>" alt="">
                        </button>
                        <button class="fromza az-item" data-sort-type="za">
                            <p>Sort name by </p> 
                            <img class="za" src="<?php echo e(asset('/img/59372.png')); ?>" alt="">
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="products">
                ...
                <div class="products-container">
                    ...
                    <a href="/watch/<?php echo e($watch->slug); ?>" style="text-decoration:underline">
                        <div class="product-object">
                            <img class="object-img" src="<?php echo e(asset($watch->img1)); ?>" alt="">
                            <div class="object-section">
                                <div class="object-section-info">
                                    <a href="/watch/<?php echo e($watch->slug); ?> " class=" has-link object-info info-name"> <?php echo e($watch->name); ?></a>
                                </div>
                                <div class="object-section-info">
                                    <h3 class="item-price"><?php echo e($watch->price * (1 - $watch->discount)); ?></h3> <span>VND</span>
                                </div>
                            </div>
                            <div class="buy-btn">
                                <a id='<?php echo e($watch->id); ?>' class="discover cart">Add to cart</a>
                                <a href="/order/buy?watch_id[]=<?php echo e($watch->id); ?>&quantity[]=1" class="discover has-link">Buy Now</a>
                            </div>
                        </div>
                    </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                
...
<script src="<?php echo e(asset('js/addcart.js')); ?>"></script>
<script src="<?php echo e(asset('js/home.js')); ?>"></script>
</html><?php /**PATH D:\UIT\WEB\IS207.O11.TMCL\resources\views/home.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/css/sign-responsive.css')); ?>">
    ...
    <div class="cartier">
       <div class="heading-section">
            <div class="logo-signin">
                <img class="logo-img-sign" src="<?php echo e(asset('img/Screenshot_2023-10-16_121457-removebg.png')); ?>" alt="">
            </div>
            <div class="register-button">
                <a class="register-acc has-acc has-link-sign " href="">
                    ALREADY REGISTERED?
                </a>
                <a class="register-acc hasnt has-link-sign " href="<?php echo e(route('register')); ?>">
                    CREATE YOUR ACCOUNT
                </a>
            </div>
       </div>
...
<?php endif; ?>
                        ...
                        <a class="forgotpass has-link-sign " href="<?php echo e(route('password.request')); ?>"><?php echo e(__('Forgot your password?')); ?></a>
                        <?php endif; ?>
                        <p class="read-more">Read the <a class="term has-link-sign " href="">Privacy Policy</a> for further information</p>

                        <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'ml-3 submitform']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'ml-3 submitform']); ?>
...
</html><?php /**PATH D:\UIT\WEB\IS207.O11.TMCL\resources\views/auth/sign.blade.php ENDPATH**/ ?>
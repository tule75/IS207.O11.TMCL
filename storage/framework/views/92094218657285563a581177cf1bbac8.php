    ...
    <div class="cartier">
        ...
        <div class="header">
            ...
            <div class="main-header">
                ...
                <div class="logo">
                    <a href="/"><img class="logo-img" src="<?php echo e(asset('img/Screenshot_2023-10-16_121457-removebg.png')); ?>" alt=""></a>
                </div>
                ...
                <div class="nav-right">
                    ...
                    <?php if(Route::has('login')): ?>
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(url('/profile')); ?>" style="margin: 0; text-decoration: inherit; color: inherit;"><div class="nav-right--item"><i class="fa fa-user"></i></div></a>
                            <a href="<?php echo e(Route('cart.index')); ?>" style="margin: 0; text-decoration: inherit; color: inherit;"><div class="nav-right--item"><i class="fa fa-cart-plus"></i></div></a>
                        <?php else: ?>
            ...
            <div class="bd-content">
                <div class="grid-container" id="overview">
                    <div class="grid-item">
                        ...
                        <div class="content"><?php echo e($user->name); ?></div>
                        <div class="content"><?php echo e($user->email); ?></div>
                    </div>
                    <div class="grid-item">
                ...
                <div id="profile"><?php echo $__env->make('profile.partials.profile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></div>
                <div id="password"><?php echo $__env->make('profile.partials.password', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></div>
                <div id="order"><?php echo $__env->make('profile.partials.orders', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></div>
                <div id="wishlist"><?php echo $__env->make('profile.partials.wishlist', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></div>
                <div id="address"> <?php echo $__env->make('profile.partials.address', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></div>
                <div class="bd-content" id="collection"><?php echo $__env->make('profile.partials.collection', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></div>
                <div class="bd-content" id="subscription"><?php echo $__env->make('profile.partials.subcription', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></div>
            </div>
        </div>

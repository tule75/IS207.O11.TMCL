                        ...
                        <div class="product-object">
                            ...
                            <div class="object-section">
                                <div class="object-section-info">
                                    <a class=" has-link object-info  info-name"> <?php echo e($watch->name); ?></a>
                                </div>
                                <div class="object-section-info">
                                    <a class=" has-link object-info"><?php echo e($watch->description); ?></a>
                                    <h3 class="item-price"><?php echo e(number_format($watch->price * (1 - $watch->discount), 0, ',', '.')); ?> đ</h3>
                                </div>
                            </div>
                            <div class="buy-btn">
...
<?php /**PATH D:\UIT\WEB\New\resources\views/collection.blade.php ENDPATH**/ ?>
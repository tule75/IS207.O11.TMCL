...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/staff.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('icon/fontawesome-free-6.4.2-web/css/all.css')); ?>">
</head>
<body>
    <div class="cartier">
         <!-- header start -->
        <div class="header">
            <div class="header-left-wrap">
                ...
                <button class="icon-bars">
                    <img class="bars-img" src="<?php echo e(asset('/img/bars.png')); ?>" alt="">
                </button>
            </div>
        ...
        <div class="main-content">
            <div class="main-left">
                <div class="input-space">
                    <div class="img-btn"><img class="span-search" src="<?php echo e(asset('/img/search.png')); ?>" alt=""></div>
                ...
                <div class="select-container active">
                    <div content-todo>
                        ...
                        <div class="grid-container">
                            ...
                            <div class="grid-item-count"><?php echo e(count($pOrders)); ?>

                                <div class="grid-item-text">Chờ lấy hàng</div>
                            </div>
                            <div class="grid-item-count"><?php echo e(count($sOrders) + count($successOrders)); ?>
                            ...
                            <div class="grid-item-count"> <?php echo e(count($trashed)); ?>
                            ...
                            <div class="grid-item-count"><?php echo e(count($activeVoucher)); ?>
                        ...
                        <div class="table-field">
                            <table>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="oID">HD<?php echo e($order->id); ?></p>
                                        </td>
                                        <td>
                                            <p><?php echo e($order->total_prices); ?></p>
                                        </td>
                                        <td class="status">
                                        ...
                                        <td>
                                            <p>
                                                <?php echo e($order->address->phone_number); ?>

                                            </p>
                                        </td>
                                        <td>
                                            <p><?php echo e($order->address->address . ', '. $order->address->ward . ", " . $order->address->district . ", " . $order->address->province); ?></p>
                                        </td>
                                        <td>
                                            <?php if($order->status == 'Pending'): ?>
                        ...
                        <div class="table-field">
                            <table>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <img src="<?php echo e(asset('/img/h2.webp')); ?>" alt="" width="95px">
                                        </td>
                                        <td>
...
</html><?php /**PATH D:\UIT\WEB\New\resources\views/staff/staff.blade.php ENDPATH**/ ?>
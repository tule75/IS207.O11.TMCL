...
<div class="bd-content-field">
    <p class="bd-content-header">Required field*</p>
    <div>
        <p class="tags">Tiltle*</p>
        <input type="checkbox" id="title1" name="title1" value="">
        <label class="bd-checkbox" for="title1">Mr</label>
        <input type="checkbox" id="title2" name="title2" value="">
        <label class="bd-checkbox" for="title2">Mrs</label>
        <input type="checkbox" id="title3" name="title3" value="">
        <label class="bd-checkbox" for="title3">Miss</label>
        <input type="checkbox" id="title4" name="title4" value="">
        <label class="bd-checkbox" for="title1">Mx</label>
    </div>
    <div class="input">
    ...
    <div class="bd-choose">
        <p class="tags">Date of Birth</p>

        <label for="day"></label>
        <select id="day" class="pick">
    ...
    <div class="input">
        <p class="header-text">If you change your email address, you will need to reactivate your
            account
            from your new
            email
            address</p>
    ...
    <div class="bd-choose">
        <p class="tags">Preferred Language </p>
        <select class="choose">
            <option> </option>
    ...
    <div class="bd-choose">
        <p>
            For further information about how we use your personal information, please see our <a
                href="">Privacy Policy</a></p>
        <div class="bd-policy">
            <input type="checkbox" id="check" name="check">

            <label for="check"> I would also like to receive marketing information
                about Cartier’s
                products
                or services.
                We may send you this information using email, text, telephone or post. We may also use
                your
                information to deliver personalized messages or advertising on social media or other
                digital
                platforms. You can ask us to stop marketing at any time.</label><br>
...
<?php /**PATH D:\UIT\WEB\IS207.O11.TMCL\resources\views/profile/partials/profile.blade.php ENDPATH**/ ?>
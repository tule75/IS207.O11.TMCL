...
<body>
    <div class="cartier">
        ...
        <!--welcom-->
        <div class="banner">
            <div class="img-welcome" style="display: flex; justify-content: center;">
                <img class="banner-img-link" style="width:100px; text-align: center;" src="{{asset('img/leather.png')}}" alt="">
                
            </div>
            <div class="banner-introduction"></div>
            <div class="intro-text">
                <h2>WELCOME</h2>
                <div>Welcome to your account.</div>
                <div>You can manage your shopping experience at UITER ONLINE SHOP</div>
            </div>
        </div>
        <!--body-->
        <div class="body">
